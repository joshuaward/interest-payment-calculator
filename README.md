...
Clone this repo to your local computer using this command:
    ...
    git clone https://github.com/joshuaward/interest-payment-calculator.git

With the files downloaded, navigate to your `interest-payment-calculator` folder on the command line (or Terminal) and run `npm install` to set things up.
